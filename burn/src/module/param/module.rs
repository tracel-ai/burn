...
use crate::module::{ADModule, LoadingError, Module, State, StateNamed, Variable};
...
impl<M: Module> Variable<M::Backend> for Param<M> {
...
impl<M: Module> Variable<M::Backend> for Param<Vec<M>> {
    fn num_params(&self) -> usize {
