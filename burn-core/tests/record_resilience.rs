...
mod tests {
  ...
  fn deserialize_with_removed_optional_field_works_with_bin_file_recorder() {
    deserialize_with_removed_optional_field("bin", BinFileRecorder::<FullPrecisionSettings>::new())
      .unwrap();
  }
  ...
  fn deserialize_with_removed_constant_field_works_with_bin_file_recorder() {
    deserialize_with_removed_constant_field("bin", BinFileRecorder::<FullPrecisionSettings>::new())
      .unwrap();
  }
  ...
  where
    R: FileRecorder,
  {
    let file_path: PathBuf = format!("/tmp/deserialize_with_removed_optional_field-{name}").into();
  ...
  where
    R: FileRecorder,
  {
    let file_path: PathBuf = format!("/tmp/deserialize_with_removed_constant_field-{name}").into();
