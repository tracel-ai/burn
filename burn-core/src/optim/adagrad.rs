...
mod tests {
    ...
    fn test_adagrad_optimizer_with_numbers() {
        ...
        let weights_expected = Data::from([
            [-0.334989, 0.125844, 0.389838, 0.305364, 0.071796, 0.052695],
            [
                0.063311, -0.030056, -0.381162, 0.240364, 0.181396, -0.306605,
            ],
            [
                -0.033389, 0.023044, -0.310662, 0.233764, -0.292104, 0.298595,
            ],
            [
                -0.312389, -0.232956, -0.385962, -0.312736, -0.090204, 0.148195,
            ],
            [
                0.315611, -0.229756, 0.357238, -0.187536, 0.365496, -0.044805,
            ],
            [-0.030289, -0.023556, 0.111338, 0.177464, 0.015196, 0.368895],
        ]);
