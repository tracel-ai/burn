...
mod tests {
    ...
    fn test_adagrad_optimizer_with_numbers() {
        ...
        let weights_expected = Data::from([
            [-0.334928, 0.125589, 0.389815, 0.305364, 0.071784, 0.052697],
            [
                0.063311, -0.029985, -0.381117, 0.240366, 0.181353, -0.306550,
            ],
            [
                -0.033376, 0.022997, -0.310625, 0.233766, -0.291982, 0.298569,
            ],
            [
                -0.312332, -0.232357, -0.385917, -0.312717, -0.090163, 0.148186,
            ],
            [
                0.315582, -0.229167, 0.357217, -0.187522, 0.365407, -0.044790,
            ],
            [-0.030276, -0.023500, 0.111336, 0.177467, 0.015202, 0.368862],
        ]);
        let bias_expected = Data::from([
            -0.405208, 0.073692, -0.111708, 0.102892, 0.121892, -0.001708,
        ]);
