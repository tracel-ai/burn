...
impl<B: Backend> SimpleOptimizer<B> for RMSProp<B> {
  ...
  fn step<const D: usize>(
    ...
    let (grad, state_square_avg) = SquareAvgState::transform(self.alpha, grad, state_square_avg);
...
mod tests {
  ...
  fn test_rmsprop_optimizer_with_numbers_basic() {
    ...
    let bias_expected = Data::from([0.239199, 0.239199, 0.239199, 0.239199, 0.239199, 0.239199]);
