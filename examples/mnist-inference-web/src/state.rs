...
use burn::backend::wgpu::{compute::init_async, WebGpu, WgpuBackend, WgpuDevice};

pub type Backend = WgpuBackend<WebGpu, f32, i32>;

static STATE_ENCODED: &[u8] = include_bytes!("../model.bin");

/// Builds and loads trained parameters into the model.
pub async fn build_and_load_model() -> Model<Backend> {
    init_async::<WebGpu>(&WgpuDevice::default()).await;
