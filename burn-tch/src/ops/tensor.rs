...
impl<E: TchElement> TensorOps<Self> for LibTorch<E> {
  ...
  fn repeat<const D: usize>(tensor: TchTensor<E, D>, dim: usize, times: usize) -> TchTensor<E, D> {
  ...
  fn lower_equal<const D: usize>(lhs: TchTensor<E, D>, rhs: TchTensor<E, D>) -> TchTensor<bool, D> {
