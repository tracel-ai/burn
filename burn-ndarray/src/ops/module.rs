...
use super::{
    conv::conv2d,
    maxpool::{max_pool2d, max_pool2d_backward_naive, max_pool2d_with_indexes_naive},
};
...
impl<E: FloatNdArrayElement> ModuleOps<NdArrayBackend<E>> for NdArrayBackend<E> {
    ...
    fn max_pool2d(
        ...
        max_pool2d(x, kernel_size, stride, padding).0
    }
    ...
    fn max_pool2d_with_indexes(
        ...
        let (output, indexes) = max_pool2d(x, kernel_size, stride, padding);
