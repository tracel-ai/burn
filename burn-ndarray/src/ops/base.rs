  ...
  E: Copy,
{
  ...
  pub fn cat<const D: usize>(tensors: Vec<NdArrayTensor<E, D>>, dim: usize) -> NdArrayTensor<E, D> {
  ...
  E: Copy + NdArrayElement,
{
  ...
  pub fn mean_dim<const D: usize>(tensor: NdArrayTensor<E, D>, dim: usize) -> NdArrayTensor<E, D> {
    match D {
  ...
  fn gather_batch_size<const D: usize>(shape_tensor: &Shape<D>, shape_indices: &Shape<D>) -> usize {
  ...
  pub fn argmax<const D: usize>(tensor: NdArrayTensor<E, D>, dim: usize) -> NdArrayTensor<i64, D> {
    arg(tensor, dim, CmpType::Max)
  }

  pub fn argmin<const D: usize>(tensor: NdArrayTensor<E, D>, dim: usize) -> NdArrayTensor<i64, D> {
    arg(tensor, dim, CmpType::Min)
  }

  pub fn clamp_min<const D: usize>(mut tensor: NdArrayTensor<E, D>, min: E) -> NdArrayTensor<E, D> {
  ...
  pub fn clamp_max<const D: usize>(mut tensor: NdArrayTensor<E, D>, max: E) -> NdArrayTensor<E, D> {
