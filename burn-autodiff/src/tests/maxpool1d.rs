...
mod tests {
  ...
  fn test_max_pool1d_simple() {
    ...
    let x = TestAutodiffTensor::from_floats([[[0.9861, 0.5474, 0.4477, 0.0732, 0.3548, 0.8221]]])
      .require_grad();
  ...
  fn test_max_pool1d_with_dilation() {
    ...
    let x_grad_expected = TestAutodiffTensor::from_floats([[[
      0., 0., 1., 0., 0., 3., 0., 1., 2., 1., 0., 0., 2., 0., 0., 0., 4., 4., 0., 0., 0., 0., 0.,
      0., 1.,
    ]]]);
  ...
  fn test_max_pool1d_complex() {
    ...
    .require_grad();
    let x_grad_expected = TestAutodiffTensor::from_floats([[[
      0., 0., 0., 2., 0., 4., 0., 2., 1., 0., 0., 0., 4., 0., 0., 0., 4., 1., 1., 0., 0., 0., 1.,
      1., 1.,
    ]]]);
  ...
  fn test_max_pool1d_complex_with_padding() {
    ...
    .require_grad();
    let x_grad_expected = TestAutodiffTensor::from_floats([[[
      1., 0., 1., 2., 0., 4., 0., 2., 1., 0., 0., 0., 4., 0., 0., 0., 4., 1., 1., 0., 0., 0., 1.,
      1., 3.,
    ]]]);
