...
impl<B: FusionBackend> IntTensorOps<Self> for Fusion<B> {
    fn int_empty(shape: Shape, device: &Device<Self>) -> IntTensor<Self> {
        ...
        client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::Empty(desc.clone())),
    ...
    fn int_to_device(tensor: IntTensor<Self>, device: &Device<Self>) -> IntTensor<Self> {
        ...
        client_original
            .clone()
            .change_client_int::<B>(tensor.into_tensor_ir(), client_target, id)
    }
    ...
    fn int_reshape(tensor: IntTensor<Self>, shape: Shape) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::Reshape(desc.clone())),
    ...
    fn int_slice(tensor: IntTensor<Self>, ranges: &[Range<usize>]) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::Slice(desc.clone())),
            SliceOps::<B>::new(desc),
        );
    ...
    fn int_slice_assign(
        ...
        out.client.register(
            ...
            OperationRepr::BaseInt(BaseOperationRepr::SliceAssign(desc.clone())),
    ...
    fn int_mask_where(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MaskWhere(desc.clone()),
            ),
    ...
    fn int_mask_fill(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MaskFill(desc.clone()),
            ),
    ...
    fn int_gather(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Gather(desc.clone()),
            ),
    ...
    fn int_scatter(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Scatter(desc.clone()),
            ),
    ...
    fn int_select(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Select(desc.clone()),
            ),
    ...
    fn int_select_assign(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::SelectAssign(desc.clone()),
            ),
    ...
    fn int_cat(tensors: Vec<IntTensor<Self>>, dim: usize) -> IntTensor<Self> {
        ...
        client.register(
            streams,
            OperationRepr::BaseInt(BaseOperationRepr::Cat(desc.clone())),
            CatOps::<B>::new(desc),
        );
    ...
    fn int_equal(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::BaseInt(BaseOperationRepr::Equal(desc.clone())),
            EqualOps::<B>::new(desc),
        );
    ...
    fn int_equal_elem(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::EqualElem(desc.clone()),
            ),
    ...
    fn int_greater(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Greater(desc.clone()),
            ),
    ...
    fn int_greater_elem(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::GreaterElem(desc.clone()),
            ),
    ...
    fn int_greater_equal(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::GreaterEqual(desc.clone()),
            ),
    ...
    fn int_lower(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Lower(desc.clone()),
            ),
            LowerOps::<B>::new(desc),
        );
    ...
    fn int_lower_elem(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::LowerElem(desc.clone()),
            ),
    ...
    fn int_lower_equal(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::LowerEqual(desc.clone()),
            ),
    ...
    fn int_lower_equal_elem(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> BoolTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::LowerEqualElem(desc.clone()),
            ),
    ...
    fn int_add(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Add(desc.clone()),
            ),
            AddOps::<B>::new(desc),
        );
    ...
    fn int_add_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::AddScalar(desc.clone()),
            ),
            AddOps::<B>::new(desc),
        );
    ...
    fn int_sub(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Sub(desc.clone()),
            ),
            SubOps::<B>::new(desc),
        );
    ...
    fn int_sub_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::SubScalar(desc.clone()),
            ),
            SubOps::<B>::new(desc),
        );
    ...
    fn int_mul(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Mul(desc.clone()),
            ),
            MulOps::<B>::new(desc),
        );
    ...
    fn int_mul_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MulScalar(desc.clone()),
            ),
            MulOps::<B>::new(desc),
        );
    ...
    fn int_div(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Div(desc.clone()),
            ),
            DivOps::<B>::new(desc),
        );
    ...
    fn int_div_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::DivScalar(desc.clone()),
            ),
            DivOps::<B>::new(desc),
        );
    ...
    fn int_remainder(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Rem(desc.clone()),
            ),
            ModOps::<B>::new(desc),
        );
    ...
    fn int_remainder_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::RemScalar(desc.clone()),
            ),
            ModOps::<B>::new(desc),
        );
    ...
    fn int_sum(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Sum(desc.clone()),
            ),
            SumOps::<B>::new(desc),
        );
    ...
    fn int_sum_dim(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::SumDim(desc.clone()),
            ),
    ...
    fn int_prod(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Prod(desc.clone()),
            ),
            ProdOps::<B>::new(desc),
        );
    ...
    fn int_mean(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Mean(desc.clone()),
            ),
            MeanOps::<B>::new(desc),
        );
    ...
    fn int_mean_dim(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MeanDim(desc.clone()),
            ),
    ...
    fn int_argmax(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::ArgMax(desc.clone()),
            ),
    ...
    fn int_argmin(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::ArgMin(desc.clone()),
            ),
    ...
    fn int_clamp(
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Clamp(desc.clone()),
            ),
            ClampOps::<B>::new(desc),
        );
    ...
    fn int_abs(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Abs(desc.clone()),
            ),
            AbsOps::<B>::new(desc),
        );
    ...
    fn int_into_float(tensor: IntTensor<Self>) -> FloatTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::IntoFloat(desc.clone())),
    ...
    fn int_swap_dims(tensor: IntTensor<Self>, dim1: usize, dim2: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::SwapDims(desc.clone())),
    ...
    fn int_max(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Max(desc.clone()),
            ),
            MaxOps::<B>::new(desc),
        );
    ...
    fn int_max_dim(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MaxDim(desc.clone()),
            ),
    ...
    fn int_min(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::Min(desc.clone()),
            ),
            MinOps::<B>::new(desc),
        );
    ...
    fn int_min_dim(tensor: IntTensor<Self>, dim: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::MinDim(desc.clone()),
            ),
    ...
    fn int_random(
        ...
        client.register(
            ...
            OperationRepr::NumericInt(
                IntElem::<Self>::dtype(),
                NumericOperationRepr::IntRandom(desc.clone()),
            ),
    ...
    fn int_expand(tensor: IntTensor<Self>, shape: Shape) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::Expand(desc.clone())),
    ...
    fn int_repeat_dim(tensor: IntTensor<Self>, dim: usize, times: usize) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::BaseInt(BaseOperationRepr::RepeatDim(desc.clone())),
    ...
    fn bitwise_and(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::Int(IntOperationRepr::BitwiseAnd(desc.clone())),
    ...
    fn bitwise_and_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseAndScalar(desc.clone())),
            BitwiseAndOps::<B>::new(desc),
        );
    ...
    fn bitwise_or(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::Int(IntOperationRepr::BitwiseOr(desc.clone())),
    ...
    fn bitwise_or_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseOrScalar(desc.clone())),
            BitwiseOrOps::<B>::new(desc),
        );
    ...
    fn bitwise_xor(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::Int(IntOperationRepr::BitwiseXor(desc.clone())),
    ...
    fn bitwise_xor_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseXorScalar(desc.clone())),
            BitwiseXorOps::<B>::new(desc),
        );
    ...
    fn bitwise_not(tensor: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseNot(desc.clone())),
    ...
    fn bitwise_left_shift(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::Int(IntOperationRepr::BitwiseLeftShift(desc.clone())),
    ...
    fn bitwise_left_shift_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseLeftShiftScalar(desc.clone())),
            BitwiseLeftShiftOps::<B>::new(desc),
        );
    ...
    fn bitwise_right_shift(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream_1, stream_2],
            OperationRepr::Int(IntOperationRepr::BitwiseRightShift(desc.clone())),
    ...
    fn bitwise_right_shift_scalar(lhs: IntTensor<Self>, rhs: IntElem<Self>) -> IntTensor<Self> {
        ...
        out.client.register(
            vec![stream],
            OperationRepr::Int(IntOperationRepr::BitwiseRightShiftScalar(desc.clone())),
            BitwiseRightShiftOps::<B>::new(desc),
        );
