...
use burn_ir::{OperationRepr, TensorId};

pub use burn_common::id::StreamId;

/// A growing list of [tensor operation descriptions](OperationRepr).
pub struct OperationQueue<R: FusionRuntime> {
    ...
    pub(crate) global: Vec<OperationRepr>,
    ...
    pub(crate) relative: Vec<OperationRepr>,
