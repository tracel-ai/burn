    ...
    ($module_name:ident, $DefaultBackend:ident, $($OtherBackend:ident),+) => {
        ...
        pub mod $module_name {
                ...
                Br: MultiBackendBridge<TensorHandle = Handle<$DefaultBackend, $($OtherBackend),+>, Device = MultiDevice<$DefaultBackend, $($OtherBackend),+>>,
            {
                ...
                //type ComplexElem = Backend::ComplexElem;
...
// TODO: remove BackendRouter & update remote instead
...
//         let tensor1 = Tensor::<1>::from_floats([1.0, 2.0, 3.0, 4.0], &device1);
//         let tensor2 = Tensor::<1>::from_floats([5.0, 6.0, 7.0, 8.0], &device2);
