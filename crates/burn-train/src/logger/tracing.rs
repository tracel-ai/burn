...
/// This trait is used to install a tracing subscriber logger.
pub trait TracingSubscriberLogger {
    /// Install the tracing subscriber logger.
    fn install(&self) -> Result<(), String>;
}

/// This struct is used to install a local file tracing subscriber logger to output logs to a given file path.
pub struct FileTracingSubscriberLogger {
    path: String,
}

impl FileTracingSubscriberLogger {
    /// Create a new file tracing subscriber logger.
...
impl TracingSubscriberLogger for FileTracingSubscriberLogger {
    fn install(&self) -> Result<(), String> {
