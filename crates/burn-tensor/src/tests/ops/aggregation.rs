...
mod tests {
    ...
    fn test_should_mean() {
        ...
        data_actual.assert_approx_eq(&TensorData::from([15.0 / 6.0]), 3);
    }
    ...
    fn test_should_mean_int() {
        ...
        assert_eq!(data_actual, TensorData::from([3]));
    }
    ...
    fn test_should_sum() {
        ...
        assert_eq!(data_actual, TensorData::from([15.0]));
    }
    ...
    fn test_should_sum_int() {
        ...
        assert_eq!(data_actual, TensorData::from([15]));
    }
    ...
    fn test_should_mean_last_dim() {
        ...
        data_actual.assert_approx_eq(&TensorData::from([[3.0 / 3.0], [12.0 / 3.0]]), 3);
    }
    ...
    fn test_should_sum_last_dim() {
        ...
        assert_eq!(data_actual, TensorData::from([[3.0], [12.0]]));
    }
    ...
    fn test_should_mean_last_dim_int() {
        ...
        assert_eq!(data_actual, TensorData::from([[1], [4]]));
    }
    ...
    fn test_should_sum_last_dim_int() {
        ...
        assert_eq!(data_actual, TensorData::from([[3], [12]]));
    }
    ...
    fn test_should_sum_first_dim() {
        ...
        assert_eq!(data_actual, TensorData::from([[7.0, 3.0, 5.0]]));
    }
    ...
    fn test_should_sum_mid_dim_3d_non_contiguous_1() {
        ...
        assert_eq!(
            data_actual,
            TensorData::new(vec![9.0, 7.0, -1.0, 3.0, 4.0, 5.0], Shape::new([3, 1, 2]))
        );
    }
    ...
    fn test_should_sum_mid_dim_3d_non_contiguous_2() {
        ...
        assert_eq!(
            data_actual,
            TensorData::new(vec![5.0, 5.0, 3.0, 11.0, -3.0, 6.0], Shape::new([2, 1, 3]))
        );
    }
    ...
    fn test_prod_int() {
        ...
        assert_eq!(data_actual, TensorData::from([240]));

        let tensor_with_zero = TestTensorInt::from([[2, 0, 2], [3, 4, 5]]);
        let data_actual = tensor_with_zero.prod().to_data();

        assert_eq!(data_actual, TensorData::from([0]));
    }
    ...
    fn test_prod_dim_float() {
        ...
        TensorData::from([[4.0], [60.0]]).assert_approx_eq(&data_actual, 4);

        let tensor_with_zero = TestTensor::from([[2.0, 0.0, 2.0], [3.0, 4.0, 5.0]]);
        let data_actual = tensor_with_zero.prod_dim(1).to_data();

        TensorData::from([[0.0], [60.0]]).assert_approx_eq(&data_actual, 4);
    }
    ...
    fn test_prod_dim_int() {
        ...
        assert_eq!(data_actual, TensorData::from([[4], [60]]));

        let tensor_with_zero = TestTensorInt::from([[2, 0, 2], [3, 4, 5]]);
        let data_actual = tensor_with_zero.prod_dim(1).to_data();

        assert_eq!(data_actual, TensorData::from([[0], [60]]));
    }
}
