...
mod tests {
    use super::*;
    use burn_tensor::{Tensor, TensorData, backend::Backend, Complex, element::{Complex32, Complex64}};
    ...
    fn test_complex_from_data() {
        let data = TensorData::from([[
            Complex32 { real: 1.0, imag: 2.0 },
            Complex32 { real: 3.0, imag: 4.0 },
        ]]);
        
        let tensor = Tensor::<TestBackend, 2, Complex>::from_data(data.clone(), &Default::default());
    ...
    fn test_complex_add() {
        ...
        let tensor2 = Tensor::<TestBackend, 2, Complex>::from_data(
            TensorData::from([[
                Complex32 { real: 5.0, imag: 6.0 },
                Complex32 { real: 7.0, imag: 8.0 },
            ]]),
            &Default::default()
        );
        ...
        let expected = TensorData::from([[
            Complex32 { real: 6.0, imag: 8.0 },   // (1+5) + (2+6)i
            Complex32 { real: 10.0, imag: 12.0 }, // (3+7) + (4+8)i
        ]]);
    ...
    fn test_complex_sub() {
        ...
        let expected = TensorData::from([[
            Complex32 { real: 4.0, imag: 4.0 },   // (5-1) + (6-2)i
            Complex32 { real: 4.0, imag: 4.0 },   // (7-3) + (8-4)i
        ]]);
    ...
    fn test_complex_div() {
        let tensor1 = Tensor::<TestBackend, 2, Complex>::from_data(
            TensorData::from([[
                Complex32 { real: 1.0, imag: 1.0 },
                Complex32 { real: 2.0, imag: 0.0 },
            ]]),
            &Default::default()
        );
    ...
    fn test_complex_conj() {
        ...
        let expected = TensorData::from([[
            Complex32 { real: 1.0, imag: 2.0 },   // conjugate flips sign of imaginary part
            Complex32 { real: -3.0, imag: -4.0 },
        ]]);
    ...
    fn test_complex_magnitude() {
        let tensor = Tensor::<TestBackend, 2, Complex>::from_data(
            TensorData::from([[
                Complex32 { real: 3.0, imag: 4.0 },  // |3+4i| = 5
                Complex32 { real: 0.0, imag: 1.0 },  // |0+1i| = 1
            ]]),
            &Default::default()
        );
    ...
    fn test_complex_phase() {
        let tensor = Tensor::<TestBackend, 2, Complex>::from_data(
            TensorData::from([[
                Complex32 { real: 1.0, imag: 0.0 },  // arg(1+0i) = 0
                Complex32 { real: 0.0, imag: 1.0 },  // arg(0+1i) = π/2
            ]]),
            &Default::default()
        );
    ...
    fn test_complex_from_parts() {
        ...
        let expected = TensorData::from([[
            Complex32 { real: 1.0, imag: 5.0 },
            Complex32 { real: 2.0, imag: 6.0 },
        ], [
            Complex32 { real: 3.0, imag: 7.0 },
            Complex32 { real: 4.0, imag: 8.0 },
        ]]);
    ...
    fn test_complex_exp() {
        let tensor = Tensor::<TestBackend, 1, Complex>::from_data(
            TensorData::from([
                Complex32 { real: 0.0, imag: 0.0 },    // exp(0) = 1
                Complex32 { real: 0.0, imag: std::f32::consts::PI }, // exp(iπ) = -1
            ]),
            &Default::default()
        );
    ...
    fn test_complex_sin() {
        let tensor = Tensor::<TestBackend, 1, Complex>::from_data(
            TensorData::from([
                Complex32 { real: 0.0, imag: 0.0 },    // sin(0) = 0
                Complex32 { real: std::f32::consts::FRAC_PI_2, imag: 0.0 }, // sin(π/2) = 1
            ]),
            &Default::default()
        );
    ...
    fn test_complex_cos() {
        let tensor = Tensor::<TestBackend, 1, Complex>::from_data(
            TensorData::from([
                Complex32 { real: 0.0, imag: 0.0 },    // cos(0) = 1
                Complex32 { real: std::f32::consts::PI, imag: 0.0 }, // cos(π) = -1
            ]),
            &Default::default()
        );
    ...
    fn test_complex_log() {
        let tensor = Tensor::<TestBackend, 1, Complex>::from_data(
            TensorData::from([
                Complex32 { real: 1.0, imag: 0.0 },    // log(1) = 0
                Complex32 { real: std::f32::consts::E, imag: 0.0 }, // log(e) = 1
            ]),
            &Default::default()
        );
    ...
    fn test_complex_sqrt() {
        let tensor = Tensor::<TestBackend, 1, Complex>::from_data(
            TensorData::from([
                Complex32 { real: 4.0, imag: 0.0 },    // sqrt(4) = 2
                Complex32 { real: -1.0, imag: 0.0 },   // sqrt(-1) = i
            ]),
            &Default::default()
        );
    ...
    fn test_complex_add_scalar() {
        ...
        let scalar = Complex32 { real: 5.0, imag: 6.0 };
        let result = tensor + scalar;
        let data = result.into_data();
        
        let expected = TensorData::from([[
            Complex32 { real: 6.0, imag: 8.0 },   // (1+5) + (2+6)i
            Complex32 { real: 8.0, imag: 10.0 },  // (3+5) + (4+6)i
        ]]);
