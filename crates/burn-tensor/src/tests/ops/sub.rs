...
mod tests {
    ...
    fn should_support_sub_ops() {
        ...
        let data_expected = TensorData::from([[-6.0, -6.0, -6.0], [-6.0, -6.0, -6.0]]);
    ...
    fn test_sub_broadcast() {
        ...
        let data_expected = TensorData::from([[-3.0, -3.0, -3.0], [-6.0, -6.0, -6.0]]);
        assert_eq!(data_expected, data_actual);
    }
    ...
    fn should_support_sub_scalar_ops() {
        ...
        let data_expected = TensorData::from([[-2.0, -1.0, 0.0], [1.0, 2.0, 3.0]]);
        assert_eq!(data_expected, data_actual);
    }
    ...
    fn should_support_sub_ops_int() {
        ...
        let data_expected = TensorData::from([[-6, -6, -6], [-6, -6, -6]]);
        let device = Default::default();
    ...
    fn test_sub_broadcast_int() {
        ...
        let data_expected = TensorData::from([[-3, -3, -3], [-6, -6, -6]]);
        assert_eq!(data_expected, data_actual);
    }
    ...
    fn should_support_sub_scalar_ops_int() {
        ...
        let data_actual = output.into_data();
        let data_expected = TensorData::from([[-2, -1, 0], [1, 2, 3]]);
        assert_eq!(data_expected, data_actual);
    }
}
