...
mod tests {
    use super::*;
    use burn_tensor::{Tensor, linalg::trace};
    ...
    fn test_trace_2d_square() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<2>::from_data([[15.0]], &device); // 1 + 5 + 9 = 15
    ...
    fn test_trace_2d_rectangular_wide() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<2>::from_data([[7.0]], &device); // 1 + 6 = 7
    ...
    fn test_trace_2d_rectangular_tall() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<2>::from_data([[5.0]], &device); // 1 + 4 = 5
    ...
    fn test_trace_3d_batch() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<3>::from_data([[[5.0]], [[13.0]]], &device); // [1+4=5, 5+8=13]
    ...
    fn test_trace_4d_batch() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<4>::from_data([[[[5.0]], [[13.0]]]], &device);
    ...
    fn test_trace_single_element() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<2>::from_data([[42.0]], &device);
    ...
    fn test_trace_zeros() {
        ...
        let result = trace(tensor);
        let expected = TestTensor::<2>::from_data([[0.0]], &device);
