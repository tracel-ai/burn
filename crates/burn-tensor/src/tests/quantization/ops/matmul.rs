    ...
    fn test_matmul_mixed_block_scale() {
        ...
        let expected = TensorData::from([
            [
                ...
                60.721, 37.138, 31.582, 80.501, 50.843, 47.564, 85.313, 76.303, 74.309, 68.805,
            ],
            [
                77.180, 99.460, 96.980, 99.870, 82.010, 36.680, 95.150, 75.430, 48.810, 66.710,
                62.240, 65.450, 54.420, 73.630, 61.710, 33.420, 72.530, 85.740, 92.370, 65.440,
            ],
            [
                84.400, 119.360, 107.680, 114.090, 103.660, 41.680, 117.130, 80.0, 48.570, 78.760,
                72.640, 72.730, 66.690, 85.700, 75.720, 35.790, 74.680, 103.560, 108.270, 66.020,
            ],
        ]);
        let output = tensor_3.into_data();
