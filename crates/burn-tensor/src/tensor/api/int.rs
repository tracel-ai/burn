...
impl Tensor<1, Int> {
    ...
    pub fn arange(range: Range<i64>, options: impl Into<TensorCreationOptions>) -> Self {
        ...
        Tensor::new(PrimitiveKind::Int(Dispatch::int_arange(
            range,
            &opt.device.dispatch,
            dtype.into(),
        )))
    ...
    pub fn arange_step(
        ...
        let opt = options.into();
        let dtype = opt.resolve_dtype::<Int>();
        Tensor::new(PrimitiveKind::Int(Dispatch::int_arange_step(
            range,
            step,
            &opt.device.dispatch,
            dtype.into(),
...
impl<const D: usize> Tensor<D, Int> {
    ...
    pub fn float(self) -> Tensor<D, Float> {
        ...
        Tensor::new(PrimitiveKind::Float(Dispatch::int_into_float(
            self.primitive.into(),
            out_dtype,
        )))
    }
    ...
    pub fn bitwise_and(self, other: Self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_and(
            self.primitive.into(),
    ...
    pub fn bitwise_or(self, other: Self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_or(
            self.primitive.into(),
            other.primitive.into(),
        )))
    }
    ...
    pub fn bitwise_xor(self, other: Self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_xor(
            self.primitive.into(),
            other.primitive.into(),
        )))
    }
    ...
    pub fn bitwise_not(self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_not(
            self.primitive.into(),
        )))
    }
    ...
    pub fn bitwise_and_scalar(self, other: impl ElementConversion) -> Self {
        ...
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_and_scalar(
            self.primitive.into(),
            other,
        )))
    }
    ...
    pub fn bitwise_or_scalar(self, other: impl ElementConversion) -> Self {
        let other = Scalar::new(other, &self.dtype());
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_or_scalar(
            self.primitive.into(),
            other,
        )))
    }
    ...
    pub fn bitwise_xor_scalar(self, other: impl ElementConversion) -> Self {
        let other = Scalar::new(other, &self.dtype());
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_xor_scalar(
            self.primitive.into(),
            other,
        )))
    }
    ...
    pub fn bitwise_left_shift(self, other: Self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_left_shift(
            self.primitive.into(),
            other.primitive.into(),
        )))
    }
    ...
    pub fn bitwise_right_shift(self, other: Self) -> Self {
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_right_shift(
            self.primitive.into(),
            other.primitive.into(),
        )))
    }
    ...
    pub fn bitwise_left_shift_scalar(self, other: impl ElementConversion) -> Self {
        let other = Scalar::new(other, &self.dtype());
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_left_shift_scalar(
            self.primitive.into(),
            other,
        )))
    }
    ...
    pub fn bitwise_right_shift_scalar(self, other: impl ElementConversion) -> Self {
        let other = Scalar::new(other, &self.dtype());
        Self::new(PrimitiveKind::Int(Dispatch::bitwise_right_shift_scalar(
            self.primitive.into(),
            other,
        )))
    }
