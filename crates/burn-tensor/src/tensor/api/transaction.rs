use super::Tensor;
use crate::{TensorData, backend::ExecutionError, kind::Transaction, ops::TransactionPrimitive};
use alloc::vec::Vec;
...
impl Transaction {
    ...
    pub fn register<const D: usize, K: Transaction>(mut self, tensor: Tensor<D, K>) -> Self {
