...
pub trait DynCompatBackend<B: Backend>:
    Backend<DynTensorPrimitive = B::DynTensorPrimitive>
{
}

impl<P, B: Backend<DynTensorPrimitive = P>> DynPrimBackend<P> for B {}

impl<B: Backend, CompatB: Backend<DynTensorPrimitive = B::DynTensorPrimitive>> DynCompatBackend<B>
    for CompatB
{
}
...
impl<P> DynTensor<P> {
    ...
    pub fn from_dyn_data<FElem: Element, IElem: Element, B: Backend<DynTensorPrimitive = P>>(
        data: DynData<FElem, IElem>,
        device: &Device<B>,
    ) -> Self {
        Self {
    ...
    pub fn into_dyn_data<B: Backend<DynTensorPrimitive = P>>(
        self,
    ) -> DynData<B::FullPrecisionElem, B::IntElem> {
