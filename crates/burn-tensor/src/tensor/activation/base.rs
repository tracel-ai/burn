...
pub fn leaky_relu<const D: usize>(tensor: Tensor<D>, negative_slope: f64) -> Tensor<D> {
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::leaky_relu(
...
pub fn gelu<const D: usize>(tensor: Tensor<D>) -> Tensor<D> {
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::gelu(
        tensor.primitive.into_float(),
    )))
}
...
pub fn prelu<const D: usize>(tensor: Tensor<D>, alpha: Tensor<1>) -> Tensor<D> {
    ...
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::prelu(
        tensor.primitive.into_float(),
...
pub fn softmax<const D: usize>(tensor: Tensor<D>, dim: usize) -> Tensor<D> {
    ...
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::softmax(
        tensor.primitive.into_float(),
        dim,
    )))
}
...
pub fn softmin<const D: usize>(tensor: Tensor<D>, dim: usize) -> Tensor<D> {
    ...
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::softmin(
        tensor.primitive.into_float(),
        dim,
    )))
}
...
pub fn log_softmax<const D: usize>(tensor: Tensor<D>, dim: usize) -> Tensor<D> {
    ...
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::log_softmax(
        tensor.primitive.into_float(),
        dim,
    )))
}
...
pub fn sigmoid<const D: usize>(tensor: Tensor<D>) -> Tensor<D> {
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::sigmoid(
        tensor.primitive.into_float(),
    )))
}
...
pub fn hard_sigmoid<const D: usize>(tensor: Tensor<D>, alpha: f64, beta: f64) -> Tensor<D> {
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::hard_sigmoid(
        tensor.primitive.into_float(),
        alpha.into(),
        beta.into(),
    )))
...
pub fn log_sigmoid<const D: usize>(tensor: Tensor<D>) -> Tensor<D> {
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::log_sigmoid(
        tensor.primitive.into_float(),
    )))
}
