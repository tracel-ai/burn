...
use crate::{
    ...
    ops::{
        ...
        InterpolateOptions, PadMode, PaddedConvOptions, PrimitiveKind, UnfoldOptions,
    },
};
...
pub fn ctc_loss(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::ctc_loss(
...
pub fn embedding(weights: Tensor<2>, indices: Tensor<2, Int>) -> Tensor<3> {
    Tensor::new(PrimitiveKind::Float(Dispatch::embedding(
...
pub fn conv1d(
    ...
    if let Some(padding_end) = padded_options.padding_end {
        ...
        Tensor::new(PrimitiveKind::Float(Dispatch::conv1d(
...
pub fn conv2d(
    ...
    if let Some(padding_end) = padded_options.padding_end {
        ...
        Tensor::new(PrimitiveKind::Float(Dispatch::conv2d(
            padded.primitive.into_float(),
            weight.primitive.into_float(),
            bias.map(|b| b.primitive.into_float()),
            zero_options,
...
pub fn conv3d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::conv3d(
        x.primitive.into_float(),
        weight.primitive.into_float(),
        bias.map(|b| b.primitive.into_float()),
        padded_options.options,
...
pub fn deform_conv2d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::deform_conv2d(
        x.primitive.into_float(),
...
pub fn conv_transpose1d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::conv_transpose1d(
        x.primitive.into_float(),
        weight.primitive.into_float(),
        bias.map(|b| b.primitive.into_float()),
        options,
...
pub fn conv_transpose2d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::conv_transpose2d(
        x.primitive.into_float(),
        weight.primitive.into_float(),
        bias.map(|b| b.primitive.into_float()),
        options,
...
pub fn conv_transpose3d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::conv_transpose3d(
        x.primitive.into_float(),
        weight.primitive.into_float(),
        bias.map(|b| b.primitive.into_float()),
        options,
...
pub fn unfold4d(x: Tensor<4>, kernel_size: [usize; 2], options: UnfoldOptions) -> Tensor<3> {
    Tensor::new(PrimitiveKind::Float(Dispatch::unfold4d(
        x.primitive.into_float(),
        kernel_size,
        options,
    )))
...
pub fn max_pool1d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::max_pool1d(
        x.primitive.into_float(),
        kernel_size,
        stride,
        padding,
...
pub fn max_pool2d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::max_pool2d(
        x.primitive.into_float(),
        kernel_size,
        stride,
        padding,
...
pub fn avg_pool2d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::avg_pool2d(
        x.primitive.into_float(),
        kernel_size,
        stride,
        padding,
...
pub fn avg_pool1d(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::avg_pool1d(
        x.primitive.into_float(),
        kernel_size,
        stride,
        padding,
...
pub fn max_pool1d_with_indices(
    ...
    (
        Tensor::new(PrimitiveKind::Float(output.output)),
        Tensor::new(PrimitiveKind::Int(output.indices)),
    )
}
...
pub fn adaptive_avg_pool2d(x: Tensor<4>, output_size: [usize; 2]) -> Tensor<4> {
    Tensor::new(PrimitiveKind::Float(Dispatch::adaptive_avg_pool2d(
        x.primitive.into_float(),
        output_size,
    )))
}
...
pub fn adaptive_avg_pool1d(x: Tensor<3>, output_size: usize) -> Tensor<3> {
    Tensor::new(PrimitiveKind::Float(Dispatch::adaptive_avg_pool1d(
        x.primitive.into_float(),
        output_size,
    )))
}
...
pub fn interpolate(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::interpolate(
        x.primitive.into_float(),
        output_size,
        options,
    )))
...
pub fn linear<const D: usize>(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::linear(
...
pub fn attention(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::attention(
...
pub fn attention_fallback(
    ...
    Tensor::new(PrimitiveKind::Float(
...
pub fn conv2d_weight_backward(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::conv2d_weight_backward(
        x.primitive.into_float(),
        weight.primitive.into_float(),
...
pub fn avg_pool2d_backward(
    ...
    Tensor::new(PrimitiveKind::Float(Dispatch::avg_pool2d_backward(
        x.primitive.into_float(),
...
pub fn layer_norm<const D: usize>(
    ...
    Tensor::from_primitive(PrimitiveKind::Float(Dispatch::layer_norm(
        input.primitive.into_float(),
