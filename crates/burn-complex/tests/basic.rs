...
use burn_tensor::{Bool, Complex, ComplexScalar, IndexingUpdateOp, Int, Tensor, TensorData};
use common::*;
            ...
            paste::paste! {
                mod [<$variant:snake>] {
                    ...
                    fn test_complex_scatter_nd() {
                        ...
                        let result =
                            data.scatter_nd::<2, 2>(indices, values, IndexingUpdateOp::Assign);
                    ...
                    fn test_complex_scatter_nd_add() {
                        ...
                        let result =
                            data.scatter_nd::<2, 1>(indices, values, IndexingUpdateOp::Add);
                        let result_data = result.into_data();
