...
#[cube]
impl<EIn: JitElement, EOut: JitElement> ReduceDimShared<EIn, EOut> for MeanDim {
    ...
    fn assign_shared(
        ...
        let mean = shared_memory[0] / EIn::cast_from(shape_reduce_dim);
        output[write_position] = EOut::cast_from(mean);
    }
}
