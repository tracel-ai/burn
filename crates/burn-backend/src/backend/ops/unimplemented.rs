...
use crate::{Backend, BackendTypes, ComplexTensorBackend, InterleavedLayout, UnimplementedTensorPrimitive, ops::ComplexTensorOps};
    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    fn complex_from_real_data(_data: burn_std::TensorData, _device: &Self::Device) -> crate::ComplexTensor<Self> {
        panic!("{}", complex_panic_message())
    }

    fn complex_from_imag_data(_data: burn_std::TensorData, _device: &Self::Device) -> crate::ComplexTensor<Self> {
        panic!("{}",complex_panic_message())
    }
    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    fn complex_to_device(_tensor: crate::ComplexTensor<B>, _device: &<B>::Device) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_reshape(_tensor: crate::ComplexTensor<B>, _shape: burn_std::Shape) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_add(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_sub(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_mul(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_div(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn conj(_tensor: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn real(_tensor: crate::ComplexTensor<B>) -> crate::tensor::FloatTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn imag(_tensor: crate::ComplexTensor<B>) -> crate::tensor::FloatTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn abs(_tensor: crate::ComplexTensor<B>) -> crate::tensor::FloatTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_from_parts(_real: burn_std::TensorData, _imag: burn_std::TensorData) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_from_polar(_magnitude: crate::tensor::FloatTensor<B>, _phase: crate::tensor::FloatTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_powc(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_slice(_tensor: crate::ComplexTensor<B>, _slices: &[burn_std::Slice]) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_swap_dims(_tensor: crate::ComplexTensor<B>, _dim1: usize, _dim2: usize) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_repeat_dim(_tensor: crate::ComplexTensor<B>, _dim: usize, _times: usize) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_cat(_tensors: alloc::vec::Vec<crate::ComplexTensor<B>>, _dim: usize) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_permute(_tensor: crate::ComplexTensor<B>, _axes: &[usize]) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_expand(_tensor: crate::ComplexTensor<B>, _shape: burn_std::Shape) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_remainder(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_remainder_scalar(_lhs: crate::ComplexTensor<B>, _rhs: burn_std::Scalar) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
    ...
    fn complex_powc_scalar(_lhs: crate::ComplexTensor<B>, _rhs: burn_std::Scalar) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_powf(_lhs: crate::ComplexTensor<B>, _rhs: crate::tensor::FloatTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_powf_scalar(_lhs: crate::ComplexTensor<B>, _rhs: burn_std::Scalar) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }

    fn complex_matmul(_lhs: crate::ComplexTensor<B>, _rhs: crate::ComplexTensor<B>) -> crate::ComplexTensor<B> {
        panic!("{}",complex_panic_message())
    }
