...
impl TypedDevice<Dispatch> for Dispatch {
    fn complex_device(tensor: &ComplexTensor<Self>) -> Self::Device {
        tensor.device()
    }
}
impl ComplexTensorOps<Self> for Dispatch {
            ...
            match device {
                ...
                crate::DispatchDevice::Autodiff(inner) => {
                    {
                        match (&**inner){
                            #[cfg(feature = "cpu")]
                            crate::DispatchDevice::Cpu(device) => {
                                with_autodiff_backend!(Cpu,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Cpu,(Some(inner.checkpointing)),{
                                        {
                            ...
                            #[cfg(feature = "cuda")]
                            crate::DispatchDevice::Cuda(device) => {
                                with_autodiff_backend!(Cuda,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Cuda,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(wgpu_metal)]
                            crate::DispatchDevice::Metal(device) => {
                                with_autodiff_backend!(Metal,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Metal,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(feature = "rocm")]
                            crate::DispatchDevice::Rocm(device) => {
                                with_autodiff_backend!(Rocm,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Rocm,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(wgpu_vulkan)]
                            crate::DispatchDevice::Vulkan(device) => {
                                with_autodiff_backend!(Vulkan,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Vulkan,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(wgpu_webgpu)]
                            crate::DispatchDevice::Wgpu(device) => {
                                with_autodiff_backend!(Wgpu,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,Wgpu,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(feature = "flex")]
                            crate::DispatchDevice::Flex(device) => {
                                match (Some(inner.checkpointing)){
                                    Some(crate::CheckpointingStrategy::Balanced) => {
                                        type B = Autodiff<Flex<f32>,burn_autodiff::checkpoint::strategy::BalancedCheckpointing, >;
                                        {
                                            wrap_float!(@wrap_autodiff Complex,Flex,(Some(inner.checkpointing)),{
                                                {
                                                    B::complex_random(shape,distribution,device,dtype)
                                                }
                                            })
                                    ...
                                    Some(crate::CheckpointingStrategy::None) => {
                                        type B = Autodiff<Flex<f32>,burn_autodiff::checkpoint::strategy::NoCheckpointing>;
                                        {
                                            wrap_float!(@wrap_autodiff Complex,Flex,(Some(inner.checkpointing)),{
                                                {
                                                    B::complex_random(shape,distribution,device,dtype)
                            ...
                            crate::DispatchDevice::NdArray(device) => {
                                with_autodiff_backend!(NdArray,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,NdArray,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                            ...
                            #[cfg(feature = "tch")]
                            crate::DispatchDevice::LibTorch(device) => {
                                with_autodiff_backend!(LibTorch,(Some(inner.checkpointing)), |B|{
                                    wrap_float!(@wrap_autodiff Complex,LibTorch,(Some(inner.checkpointing)),{
                                        {
                                            B::complex_random(shape,distribution,device,dtype)
                                        }
                                    })
                ...
                crate::DispatchDevice::Cpu(device) => {
                    ...
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Cpu(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Cuda(device) => {
                    type B = Cuda<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Cuda(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Metal(device) => {
                    type B = Metal<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Metal(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Rocm(device) => {
                    type B = Rocm<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Rocm(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Vulkan(device) => {
                    type B = Vulkan<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Vulkan(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Wgpu(device) => {
                    type B = Wgpu<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Wgpu(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::Flex(device) => {
                    type B = Flex<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::Flex(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::NdArray(device) => {
                    type B = NdArray<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::NdArray(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
                ...
                crate::DispatchDevice::LibTorch(device) => {
                    type B = LibTorch<f32>;
                    crate::DispatchTensor {
                        kind: crate::DispatchTensorKind::LibTorch(crate::BackendTensor::Complex({
                            B::complex_random(shape,distribution,device,dtype)
                        })),checkpointing: None,
                    }
                }
    ...
    //     creation_op!(Complex, device, |device| B::complex_empty(shape, device, dtype))
    // }
    ...
    fn complex_zeros(
        ...
        creation_op!(Complex, device, |device| B::complex_zeros(
            shape, device, dtype
        ))
    }
    ...
    fn complex_ones(
        ...
        creation_op!(Complex, device, |device| B::complex_ones(
            shape, device, dtype
        ))
    }
