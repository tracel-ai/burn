// use burn_cube::{cube, Bool, CubeContext, FloatX, Float, Int, UInt};
// use burn_jit::gpu;
...
// // From float
// #[cube]
// pub fn float_to_float<F: Float>(x: FloatX<F>) {
//     let y = x + float_new::<F>(2.0);
//     let _ = to_float::<FloatX<F>, F>(y) + float_new::<F>(34.0);
// }

// #[cube]
// pub fn float_to_int<F: Float>(x: FloatX<F>) {
//     let y = x + float_new::<F>(2.0);
//     let _ = to_int(y) + int_new(34);
// }

// #[cube]
// pub fn float_to_uint<F: Float>(x: FloatX<F>) {
//     let y = x + float_new::<F>(2.0);
//     let _ = to_uint(y) + uint_new(34u32);
// }

// #[cube]
// pub fn float_to_bool<F: Float>(x: FloatX<F>) {
//     let y = x + float_new::<F>(2.0);
...
// // // From int
// #[cube]
// pub fn int_to_float<F: Float>(x: Int) {
//     let y = x + int_new(2);
...
// // // From uint
// #[cube]
// pub fn uint_to_float<F: Float>(x: UInt) {
...
// // From bool
// #[cube]
// pub fn bool_to_float<F: Float>(x: Bool) {
