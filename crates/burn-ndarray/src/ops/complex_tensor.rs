...
use burn_tensor::{
    ...
    backend::ComplexTensorBackend, ops::ComplexTensorOps,
};
...
//     fn real(
//         tensor: burn_tensor::ops::ComplexTensor<Self>,
//     ) -> burn_tensor::ops::FloatTensor<Self::InnerBackend> {
//         todo!()
//     }
...
//     fn to_complex(
//         tensor: burn_tensor::ops::FloatTensor<Self::InnerBackend>,
//     ) -> burn_tensor::ops::ComplexTensor<Self> {
//         todo!()
//     }
// }
