...
use crate::lr_scheduler::policy::LrPolicyScheduler;
...
impl CosineAnnealingLrSchedulerConfig {
    ...
    /// * `num_iters` is 0
    pub fn build(&self) -> Result<CosineAnnealingLrScheduler, String> {
    ...
    /// Initializes a [learning rate policy scheduler](LrPolicyScheduler).
    ///
    /// # Errors
    ///
    /// Forwards any error generated by [CosineAnnealingLrSchedulerConfig::build].
