...
//!
//! **ONNX Spec**: <https://onnx.ai/onnx/operators/onnx__Log.html>
//!
//! ## Type Constraints
//!
...
/// Node representation for Log operation
...
/// Node processor for natural logarithm operation
pub(crate) struct LogProcessor;

impl NodeProcessor for LogProcessor {
    type Config = ();
