//! Processor for Div operation

use crate::ir::Node;
use crate::processor::NodeProcessor;
use crate::util::same_as_input_broadcast;

/// Node processor for Div operation
pub struct DivProcessor;

impl NodeProcessor for DivProcessor {
...
mod tests {
    ...
    #[test]
    fn test_div_processor() {
        let processor = DivProcessor;
