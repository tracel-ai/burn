...
//!
//! Element-wise reciprocal operation (1/x).
//!
//! **ONNX Spec**: <https://onnx.ai/onnx/operators/onnx__Reciprocal.html>
//!
//! ## Type Constraints
//!
...
/// Node processor for reciprocal operation
pub(crate) struct ReciprocalProcessor;

impl NodeProcessor for ReciprocalProcessor {
    type Config = ();
