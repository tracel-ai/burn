//! Processor for BitwiseXor operation

use crate::ir::Node;
use crate::processor::NodeProcessor;
use crate::util::same_as_input_broadcast;

/// Node processor for BitwiseXor operation
pub struct BitwiseXorProcessor;
...
mod tests {
    ...
    #[test]
    fn test_bitwise_xor_processor() {
        let processor = BitwiseXorProcessor;

        let mut node = crate::ir::Node {
            node_type: NodeType::BitwiseXor,
            name: "test_bitwise_xor".to_string(),
            inputs: vec![
                Argument {
                    name: "a".to_string(),
