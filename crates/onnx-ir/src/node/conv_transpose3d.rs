...
mod tests {
    ...
    fn create_test_node(
        ...
        let weight_tensor = TensorData {
            data: Data::Float32s(vec![0.0; 32]), // Not important for the test
            shape: vec![2, 4, 2, 2, 2], // [input_channels, output_channels/groups, k_d, k_h, k_w]
        };
        ...
        Node {
            node_type: NodeType::ConvTranspose3d,
            name: "test_convtranspose3d".to_string(),
            inputs,
