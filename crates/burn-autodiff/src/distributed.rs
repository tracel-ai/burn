...
use burn_backend::{
    ...
    distributed::{DistributedOps, DistributedParams, TensorRef},
};
...
impl<B: DistributedOps> DistributedGradientRegistration<B> {
...
impl<B: DistributedOps> DistributedRegistration for DistributedGradientRegistration<B> {
