...
mod tests {
    ...
    fn should_diff_add() {
        ...
        let expected =
            TensorData::from([1.0, 1.0]).convert::<<TestAutodiffBackend as Backend>::FloatElem>();
        ...
        let expected =
            TensorData::from([6.0, 6.0]).convert::<<TestAutodiffBackend as Backend>::FloatElem>();
    ...
    fn should_diff_add_scalar() {
        ...
        let expected =
            TensorData::from([7.0, 15.0]).convert::<<TestAutodiffBackend as Backend>::FloatElem>();
