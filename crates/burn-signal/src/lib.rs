...
#![cfg_attr(any(feature = "tch", feature = "ndarray"), allow(deprecated))]
...
//!
//! FFT kernels are available for Flex, CubeCL backends, and LibTorch. NdArray
//! supports the composed window functions but does not implement FFTs.
