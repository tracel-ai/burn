...
pub fn read<C: Scalar, N: Size>(
    ...
    match arg {
        ...
        FuseArg::BlockLocal { pos, ty } => match comptime![ty] {
            ...
            FuseType::E4M3 => Vector::cast_from(locals.l_e4m3.find(pos)),
            FuseType::E5M2 => Vector::cast_from(locals.l_e5m2.find(pos)),
...
pub fn write_scalar<C: Scalar, N: Size>(
    ...
    match arg {
        FuseArg::BlockLocal { pos, ty } => match comptime![ty] {
            ...
            FuseType::E4M3 => locals.l_e4m3.insert(pos, Vector::cast_from(value)),
            FuseType::E5M2 => locals.l_e5m2.insert(pos, Vector::cast_from(value)),
