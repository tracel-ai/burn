...
# used to generate model: onnx-tests/tests/reduce/reduce_l2.onnx
...
def build_model():
    ...
    # ReduceL2, keepdims=0, axes=None
    reduce_l2_1 = onnx.helper.make_node(
        "ReduceL2",
        inputs=["input"],
        outputs=["output1"],
        name="ReduceL2_1",
    ...
    # ReduceL2, keepdims=1, axes=[1]
    reduce_l2_2 = onnx.helper.make_node(
        "ReduceL2",
        inputs=["input"],
        outputs=["output2"],
        name="ReduceL2_2",
    ...
    reduce_l2_3 = onnx.helper.make_node(
        "ReduceL2",
        inputs=["input"],
        outputs=["output3"],
        name="ReduceL2_3",
    ...
    # ReduceL2, keepdims=0, axes=[0]
    reduce_l2_4 = onnx.helper.make_node(
        "ReduceL2",
        inputs=["input"],
        outputs=["output4"],
        name="ReduceL2_4",
    ...
    # ReduceL2, keepdims=0, axes=[0, 2]
    reduce_l2_5 = onnx.helper.make_node(
        "ReduceL2",
        inputs=["input"],
        outputs=["output5"],
        name="ReduceL2_5",
    ...
    graph = onnx.helper.make_graph(
        [reduce_l2_1, reduce_l2_2, reduce_l2_3, reduce_l2_4, reduce_l2_5],
        'ReduceL2Model',
        [input],
