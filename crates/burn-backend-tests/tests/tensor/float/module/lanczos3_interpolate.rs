...
fn test_upsample_2x() {
    ...
    test.assert_output(TestTensor::from([[[
        [
            -0.0000, 0.3302, 0.8425, 1.2837, 1.7053, 2.1538, 2.6534, 3.0000,
        ],
        [
            1.3209, 1.6422, 2.1573, 2.5929, 3.0122, 3.4614, 3.9527, 4.3046,
        ],
        [
            3.3702, 3.6816, 4.2076, 4.6401, 5.0612, 5.5173, 6.0020, 6.3665,
        ],
        [
            5.1349, 5.4360, 5.9682, 6.3953, 6.8153, 7.2746, 7.7507, 8.1240,
        ],
        [
            6.8214, 7.1132, 7.6525, 8.0756, 8.4956, 8.9590, 9.4280, 9.8104,
        ],
        [
            8.6152, 8.8982, 9.4463, 9.8660, 10.2871, 10.7560, 11.2185, 11.6116,
        ],
        [
            10.6137, 10.8843, 11.4388, 11.8518, 12.2711, 12.7429, 13.1949, 13.5974,
        ],
        [
            12.0000, 12.2649, 12.8280, 13.2400, 13.6616, 14.1392, 14.5881, 15.0000,
        ],
    ]]]));
}
