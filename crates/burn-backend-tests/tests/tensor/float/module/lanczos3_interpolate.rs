...
fn test_upsample_2x() {
    ...
    test.assert_output(TestTensor::from([[[
        [
            -0.0000, 0.3320, 0.8436, 1.2884, 1.7116, 2.1564, 2.6680, 3.0000,
        ],
        [
            1.3282, 1.6602, 2.1717, 2.6166, 3.0397, 3.4846, 3.9961, 4.3282,
        ],
        [
            3.3743, 3.7063, 4.2178, 4.6627, 5.0858, 5.5307, 6.0422, 6.3743,
        ],
        [
            5.1537, 5.4857, 5.9973, 6.4421, 6.8653, 7.3101, 7.8217, 8.1537,
        ],
        [
            6.8463, 7.1783, 7.6899, 8.1347, 8.5579, 9.0027, 9.5143, 9.8463,
        ],
        [
            8.6257, 8.9578, 9.4693, 9.9142, 10.3373, 10.7822, 11.2937, 11.6257,
        ],
        [
            10.6718, 11.0039, 11.5154, 11.9603, 12.3834, 12.8283, 13.3398, 13.6718,
        ],
        [
            12.0000, 12.3320, 12.8436, 13.2884, 13.7116, 14.1564, 14.6680, 15.0000,
        ],
    ]]]));
}
