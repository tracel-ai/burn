...
fn test_conv2d_different_channels() {
    ...
    let grads = Grads {
        ...
        bias: TestTensor::from_data([32., 32., 32.], &device),
    };
    test.assert_grads(grads);
}
...
fn test_conv2d_different_padding() {
    ...
    let grads = Grads {
        ...
        bias: TestTensor::from_data([24., 24.], &device),
    };
    test.assert_grads(grads);
}
...
fn test_conv2d_stride_2() {
    ...
    let grads = Grads {
        ...
        bias: TestTensor::from_data([9., 9.], &device),
    };
    test.assert_grads(grads);
}
...
fn test_conv2d_groups_stride_2() {
    ...
    let grads = Grads {
        ...
        bias: TestTensor::from_data([4., 4., 4., 4.], &device),
    };
    test.assert_grads(grads);
}
...
fn test_conv2d_groups_different_channels() {
    ...
    let grads = Grads {
        ...
        bias: TestTensor::from_data([4., 4., 4., 4., 4., 4.], &device),
    };
    test.assert_grads(grads);
}
