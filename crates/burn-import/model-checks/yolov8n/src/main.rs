...
pub mod yolov8n {
    include!(concat!(env!("OUT_DIR"), "/model/yolov8n_opset16.rs"));
}
...
fn main() {
    println!("========================================");
    println!("YOLOv8n Burn Model Test");
    println!("========================================\n");
    ...
    println!("Initializing YOLOv8n model...");
    let start = Instant::now();
    let device = Default::default();
    let model: yolov8n::Model<MyBackend> = yolov8n::Model::default();
    ...
    // Verify expected output shape for YOLOv8n
