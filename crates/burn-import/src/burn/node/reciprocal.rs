...
impl<PS: PrecisionSettings> NodeCodegen<PS> for ReciprocalNode {
    ...
    fn forward(&self, scope: &mut Scope, node_position: usize) -> TokenStream {
        let input = match &self.input {
            ...
            _ => panic!("Reciprocal input must be a tensor or scalar"),
        };
...
mod tests {
    ...
    #[test]
    fn test_codegen_reciprocal() {
        let mut graph = BurnGraph::<FullPrecisionSettings>::default();

        graph.register(ReciprocalNode::new(
