...
use super::{
    ...
    random_uniform_like::RandomUniformLikeNode, range::RangeNode, reduce_mean::ReduceMeanNode,
    reshape::ReshapeNode, resize::ResizeNode, round::RoundNode, slice::SliceNode, split::SplitNode,
...
macro_rules! match_all {
    ($self:expr, $func:expr) => {{
        ...
        match $self {
            ...
            Node::ReduceMean(node) => $func(node),
