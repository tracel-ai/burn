...
impl<PS: PrecisionSettings> NodeCodegen<PS> for PowfNode {
    ...
    fn forward(&self, scope: &mut Scope, node_position: usize) -> TokenStream {
        ...
        let function = match &self.rhs {
            Type::Tensor(_) => quote! { #lhs.powf(#rhs) },
            Type::Scalar(_) => quote! { #lhs.powf_scalar(#rhs) },
...
impl OnnxIntoNode for PowfNode {
