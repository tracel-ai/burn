...
impl<PS: PrecisionSettings> NodeCodegen<PS> for PowiNode {
    ...
    fn forward(&self, scope: &mut Scope, node_position: usize) -> TokenStream {
        ...
        let function = match &self.rhs {
            Type::Tensor(_) => quote! { #lhs.powi(#rhs) },
            Type::Scalar(_) => quote! { #lhs.powi_scalar(#rhs) },
