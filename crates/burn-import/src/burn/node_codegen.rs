        ...
        impl<PS: PrecisionSettings + 'static> NodeCodegen<PS> for Node {
            ...
            fn forward(&self, scope: &mut Scope, node_position: usize) -> TokenStream {
                match self {
                    ...
                    // Scan is disabled - return empty tokens
                    Node::Scan(_) => quote::quote! {},
            ...
            fn field_serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
                match self {
                    ...
                    // Scan is disabled - serialize unit
                    Node::Scan(_) => {
                        use serde::Serialize;
...
impl_node_codegen_dispatch! {
    ...
    If,
    Loop,
    // TODO: Scan needs Type abstraction removal
    // Scan,
