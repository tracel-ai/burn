...
fn main() {
    ...
    ModelGen::new()
        ...
        .input("tests/reduce_mean/reduce_mean_no_keepdims.onnx")
        .input("tests/reduce_mean/reduce_mean_all_dims.onnx")
        .input("tests/reduce_mean/reduce_mean_multi_axes.onnx")
