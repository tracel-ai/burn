...
# used to generate model: avg_pool1d_ceil_mode.onnx
# Tests ceil_mode=True for AvgPool1d which produces larger output when input doesn't divide evenly
...
def main():
    ...
    file_name = "avg_pool1d_ceil_mode.onnx"
