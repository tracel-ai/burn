...
# used to generate model: attention_custom_scale.onnx
...
if __name__ == "__main__":
    ...
    file_name = "attention_custom_scale.onnx"
    ...
    session = ReferenceEvaluator("attention_custom_scale.onnx", verbose=1)
