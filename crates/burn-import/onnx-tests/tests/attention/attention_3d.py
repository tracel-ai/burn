...
# used to generate model: attention_3d.onnx
...
def build_model():
    ...
    q = onnx.helper.make_tensor_value_info("q", TensorProto.FLOAT, [1, 2, 2])
    k = onnx.helper.make_tensor_value_info("k", TensorProto.FLOAT, [1, 2, 2])
    v = onnx.helper.make_tensor_value_info("v", TensorProto.FLOAT, [1, 2, 2])
    y = onnx.helper.make_tensor_value_info("y", TensorProto.FLOAT, [1, 2, 2])
...
if __name__ == "__main__":
    ...
    session = ReferenceEvaluator("attention_3d.onnx", verbose=1)
