...
mod tests {
    ...
    fn transpose() {
        ...
        let input = Tensor::<Backend, 3>::from_floats(
            [
                [
                    [1.92691529, 1.48728406, 0.90071720, -2.10552096],
                    [0.67841846, -1.23454487, -0.04306748, -1.60466695],
                ...
                [
                    ...
                    [-0.59200054, -0.06307438, -0.82855427, 0.33089843],
                ],
            ],
            &device,
        );
        ...
        let expected = Data::from([
            [
                [1.92691529, 0.67841846, 0.35585991],
                [-1.11090386, -0.30972677, -0.59200054],
            ],
            [
                [1.48728406, -1.23454487, -0.68662298],
                [0.09154566, -0.39571050, -0.06307438],
            ],
            [
                [0.90071720, -0.04306748, -0.49335635],
                [-2.31692266, 0.80340934, -0.82855427],
            ],
            [
                [-2.10552096, -1.60466695, 0.24148779],
                [-0.21680473, -0.62159538, 0.33089843],
            ],
        ]);
