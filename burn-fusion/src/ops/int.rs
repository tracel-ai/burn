use crate::{
  ...
  graph::{
    ...
    GatherOpsDescription, MaskFillOpsDescription, MaskWhereOpsDescription, NumericOpsDescription,
    Ops, ReduceDimWithIndicesDescription, ReshapeDescription, ScalarOpsDescription,
  ...
  fn int_slice<const D1: usize, const D2: usize>(
    ...
    impl<const D1: usize, const D2: usize, B: FusionBackend> Ops<B> for SliceOps<D1, D2> {
      ...
      fn execute(&self, args: &Self::Args, handles: &mut crate::HandleContainer<B>) {
        ...
        let output = B::int_slice::<D1, D2>(tensor, args.ranges.clone().try_into().unwrap());
  ...
  fn int_slice_assign<const D1: usize, const D2: usize>(
    ...
    impl<const D1: usize, const D2: usize, B: FusionBackend> Ops<B> for SliceAssignOps<D1, D2> {
      ...
      fn execute(&self, args: &Self::Args, handles: &mut crate::HandleContainer<B>) {
        ...
        let output =
          B::int_slice_assign::<D1, D2>(tensor, args.ranges.clone().try_into().unwrap(), value);
