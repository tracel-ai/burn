...
//
//         collector.add_event_train(Event::ProcessedItem(LearnerItem::new(
//             value,
//             dummy_progress,
//             epoch,
//             num_epochs,
...
//         collector.add_event_train(Event::EndEpoch(epoch));
//         collector.add_event_valid(Event::EndEpoch(epoch));
//     }
//
