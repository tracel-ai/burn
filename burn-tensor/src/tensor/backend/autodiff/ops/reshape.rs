...
where
    P: Element,
    T1: TensorTrait<P, D1> + TensorOpsReshape<P, D1, D2, Output = T2>,
    T2: TensorTrait<P, D2> + TensorOpsReshape<P, D2, D1, Output = T1>,
{
...
impl<P, const D1: usize, const D2: usize, T1, T2> TensorOpsReshape<P, D1, D2>
