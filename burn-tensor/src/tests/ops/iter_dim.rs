...
mod test {
    ...
    fn test_iter_dim_double_end() {
        let input = Tensor::<TestBackend, 1, Int>::arange(0..(4 * 6 * 3)).reshape([4, 6, 3]);
        ...
        #[rustfmt::skip]
        let ele3 = Data::from([[[9, 10, 11]], [[27, 28, 29]], [[45, 46, 47]], [[63, 64, 65]]]);
        #[rustfmt::skip]
        let ele4 = Data::from([[[12, 13, 14]], [[30, 31, 32]], [[48, 49, 50]], [[66, 67, 68]]]);
        #[rustfmt::skip]
        let ele5 = Data::from([[[15, 16, 17]], [[33, 34, 35]], [[51, 52, 53]], [[69, 70, 71]]]);
    ...
    fn test_iter_dim_single_element() {
        let input = Tensor::<TestBackend, 1, Int>::arange(0..(4 * 1 * 3)).reshape([4, 1, 3]);
