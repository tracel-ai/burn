...
mod tests {
    ...
    #[test]
    fn should_squeeze() {
        let tensor = Tensor::<TestBackend, 3>::ones_devauto(Shape::new([2, 1, 4]));
    ...
    fn should_squeeze_first() {
        let tensor = Tensor::<TestBackend, 4>::ones_devauto(Shape::new([1, 3, 4, 5]));
    ...
    fn should_squeeze_last() {
        let tensor = Tensor::<TestBackend, 4>::ones_devauto(Shape::new([2, 3, 4, 1]));
    ...
    fn should_unsqueeze_dim() {
        let tensor = Tensor::<TestBackend, 3>::ones_devauto(Shape::new([2, 4, 1]));
    ...
    fn should_unsqueeze_dim_last() {
        let tensor = Tensor::<TestBackend, 4>::ones_devauto(Shape::new([5, 4, 3, 2]));
