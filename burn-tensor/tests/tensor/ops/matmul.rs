...
fn test_matmul_d2() {
    ...
    let tensor_1 = Tensor::<2, TestBackend>::from_data(data_1.clone());
    let tensor_2 = Tensor::<2, TestBackend>::from_data(data_2.clone());
...
fn test_matmul_d3() {
    ...
    let tensor_1 = Tensor::<3, TestBackend>::from_data(data_1.clone());
    let tensor_2 = Tensor::<3, TestBackend>::from_data(data_2.clone());
