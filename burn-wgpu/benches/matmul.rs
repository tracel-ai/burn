  ...
  G: GraphicsApi,
{
  ...
  fn prepare(&self) -> Self::Args {
    let lhs = WTensor::random_device(self.shape_lhs.clone(), Distribution::Default, &self.device);
    let rhs = WTensor::random_device(self.shape_rhs.clone(), Distribution::Default, &self.device);
