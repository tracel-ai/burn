...
impl<I: IntElement, const D: usize> MeanDimIntAutotuneOperationSet<I, D> {
...
impl<I: IntElement, const D: usize> AutotuneOperationSet<WgpuAutotuneKey>
    for MeanDimIntAutotuneOperationSet<I, D>
{
    fn key(&self) -> WgpuAutotuneKey {
        self.key.clone()
    }
...
/// Executes autotune on mean_dim operation
pub fn int_mean_dim_autotune<I: IntElement, const D: usize>(
    input: WgpuTensor<I, D>,
    reduce_dim: usize,
) -> WgpuTensor<I, D> {
    let client = input.client.clone();
