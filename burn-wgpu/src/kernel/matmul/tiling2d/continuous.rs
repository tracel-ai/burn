...
impl<
        ...
        const WORKGROUP_SIZE_Y: usize,
    > StaticKernel
    for MatmulTiling2DContinuous<B_M, B_N, B_K, T_M, T_N, WORKGROUP_SIZE_X, WORKGROUP_SIZE_Y>
{
    fn source_template() -> SourceTemplate {
        register_template::<B_M, B_N, B_K, T_M, T_N, WORKGROUP_SIZE_X, WORKGROUP_SIZE_Y>(
            MatmulTiling2DContinuousRaw::source_template(),
        )
    }
}
...
>(
    ...
    let kernel = lhs.context.compile_static::<KernelSettings<
        MatmulTiling2DContinuous<B_M, B_N, B_K, T_M, T_N, WORKGROUP_SIZE_X, WORKGROUP_SIZE_Y>,
        E,
        i32,
        WORKGROUP_SIZE_X,
        WORKGROUP_SIZE_Y,
