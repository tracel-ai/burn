...
mod tests {
    ...
    fn repeat_dim_0_few_times() {
        let tensor = Tensor::<TestBackend, 3>::random_default([1, 6, 6], Distribution::Default);
        let dim = 0;
        let times = 4;
    ...
    fn repeat_dim_1_few_times() {
        let tensor = Tensor::<TestBackend, 3>::random_default([6, 1, 6], Distribution::Default);
        let dim = 1;
        let times = 4;
        let tensor_ref = Tensor::<ReferenceBackend, 3>::from_data_default(tensor.to_data());
    ...
    fn repeat_dim_2_few_times() {
        let tensor = Tensor::<TestBackend, 3>::random_default([6, 6, 1], Distribution::Default);
        let dim = 2;
        let times = 4;
        let tensor_ref = Tensor::<ReferenceBackend, 3>::from_data_default(tensor.to_data());
    ...
    fn repeat_dim_2_many_times() {
        let tensor = Tensor::<TestBackend, 3>::random_default([10, 10, 1], Distribution::Default);
        let dim = 2;
        let times = 200;
        let tensor_ref = Tensor::<ReferenceBackend, 3>::from_data_default(tensor.to_data());
