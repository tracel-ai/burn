...
mod tests {
    ...
    fn test_fusion_same_behavior() {
        ...
        let data_1 =
            Tensor::<FusedBackend, 2>::random_default([1, 32], burn_tensor::Distribution::Default)
                .into_data();
        let data_2 =
            Tensor::<Backend, 2>::random_default([32, 32], burn_tensor::Distribution::Default)
                .into_data();
    ...
    fn test_end_condition_scalar_ops() {
        ...
        let tensor1 = Tensor::<Backend, 2>::ones_default([32, 32]);
        let tensor2 = Tensor::<Backend, 2>::ones_default([32, 42]);
    ...
    fn execute<B: Backend>(
        ...
        let tensor_1 = Tensor::<B, 2>::from_data_default(data_1.convert());
        let tensor_2 = Tensor::<B, 2>::from_data_default(data_2.convert());
