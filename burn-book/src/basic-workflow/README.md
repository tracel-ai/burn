...
corresponding code in the `examples/guide` [directory](https://github.com/tracel-ai/burn/tree/release/0.21/examples/guide).
...
The current version of Burn is `0.21` and the corresponding branch to checkout is `release/0.21`.
</div>
