...
| `activation::hard_shrink(tensor, lambd)`         | `nn.functional.hardshrink(tensor, lambd)`          |
...
| `activation::soft_shrink(tensor, lambd, bias)`   | `nn.functional.softshrink(tensor, lambd)`          |
